...
public class TesteCarro {
    public static void main(String[] args) {
        ...
        System.out.printf("Entre com a quantidade de acessorios desejados: ");
        quantidade = entrada.nextInt();

        //inserindo o código no Arraylist acessorios
        for(int i=1; i<=quantidade; i++){
            System.out.printf("Insira o codigo do " + i + "º acessorio desejado (0: banco de couro, 1: som, 2: insulfilm): ");
        ...
        System.out.printf("\nPreco dos acessorios = " + precoTotal);
