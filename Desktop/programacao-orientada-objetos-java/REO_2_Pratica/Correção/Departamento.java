...
public class Departamento {
    String nome, faculdade;//Erro: modificador de visibilidade
    //criando um ArrayList para guardar os professores
    ArrayList<Professor> professores;//Erro: modificador de visibilidade

    //construtor
    public Departamento(String nome, String faculdade) {
        this.nome = nome;
        this.faculdade = faculdade;
        professores = new ArrayList(); //inicializando o ArrayList //Erro: new ArrayList<>() 
    }
